...
import com.buzzware.alibi.databinding.LayoutItemsPersonBinding;

import java.util.List;


public class RecyclerViewAdapterPerson extends RecyclerView.Adapter<RecyclerViewAdapterPerson.ViewHolder>  {
    ...
    public RecyclerViewAdapterPerson(Context mContext, List<String> list) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutItemsPersonBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        LayoutItemsPersonBinding binding;

        public ViewHolder(@NonNull LayoutItemsPersonBinding binding) {
